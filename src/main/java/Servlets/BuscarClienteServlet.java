...
public class BuscarClienteServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet BuscarClienteServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<ComputadoraVenta> ventas = queryensambleComputadora.listarComputadorasParaVenta();
        HttpSession session = request.getSession();
        session.setAttribute("ventas", ventas);
        request.setAttribute("ventas", ventas);
        RequestDispatcher dispatcher = request.getRequestDispatcher("puntoDeVenta/RegistroVentas.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Cliente resultado = clienteService.obtenerClientePorNit(nit);
