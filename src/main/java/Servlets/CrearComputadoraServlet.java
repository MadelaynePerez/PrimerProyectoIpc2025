...
public class CrearComputadoraServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        ComputadoraService crearComputadora = new ComputadoraService();
        String nombre = request.getParameter("nombre");
        double precio = Double.parseDouble(request.getParameter("precio"));
        
         boolean resultado = crearComputadora.CrearComputadora(nombre, precio);
         if (resultado) {
        request.setAttribute("mensaje", "computadora Creado");    
        }else{
        request.setAttribute("mensaje", "Error, no se pudo crear");      
        }
            RequestDispatcher dispatcher = request.getRequestDispatcher("Admin/crearComputadora.jsp");
