...
public class CrearUsuarioServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        UsuarioService crearusuario = new UsuarioService();
        String usuario = request.getParameter("usuario");
        String password = request.getParameter("password");
        String rolString = request.getParameter("rol");
          int rol = Integer.parseInt(rolString);
        boolean resultado = crearusuario.CrearUsuario(usuario, password, rol);
        ...
        request.setAttribute("mensaje", "Error, no se pudo crear");      
            ...
            RequestDispatcher dispatcher = request.getRequestDispatcher("Admin/crearUsuario.jsp");
