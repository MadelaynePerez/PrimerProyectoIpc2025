 ...
 * @author Ana
 */
@WebServlet(name = "ReporteVentaServlet", urlPatterns = {"/ReporteVentaServlet"})
public class ReporteVentaServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<ReporteVentaDTO> reporteVentas = queryReportes.obtenerReporteVentas(convertirFecha.ConvertirFechaDos(fechaInicio), convertirFecha.ConvertirFechaDos(fechaFin));
        request.setAttribute("reportes", reporteVentas);
        RequestDispatcher dispatcher = request.getRequestDispatcher("Admin/reporteVentas.jsp");
