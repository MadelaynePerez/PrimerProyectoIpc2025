<%@page import="Dto.VentaComputadoraDTO"%>
<%@page import="Dto.ReporteComputadoraVendidaDTO"%>
...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <% ReporteComputadoraVendidaDTO ventas = (ReporteComputadoraVendidaDTO) request.getAttribute("reportes"); %>
            <% if (ventas != null ) { %>

            <% for (VentaComputadoraDTO venta : ventas.getVentas()) {%>
            <table>
                <thead>
                    <tr>
            ...
            <% } else { %>
            <div class="no-ventas">
                No hay computadoras en el período seleccionado.
            </div>
            <% }%>
        </div>
    </body>
