<%-- 
    Document   : consultaComprasPorCliente.jsp
    Created on : 24 feb 2025, 17:12:07
    Author     : DELL
--%>
...
<body>
    <div class="container">
        <h2>Consulta de Compras por Cliente</h2>
        <form action="consultarCompras.jsp" method="post">
