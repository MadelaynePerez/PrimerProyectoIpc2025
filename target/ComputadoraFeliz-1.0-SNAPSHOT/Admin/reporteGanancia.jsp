...
<%@page import="Dto.ReporteGananciaDTO"%>
...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <% ReporteGananciaDTO ventas = (ReporteGananciaDTO) request.getAttribute("reportes"); %>
            <% if (ventas != null) { %>
            <h1>GANANCIA TOTAL</h1>
            <% for (ProductoGananciaDTO venta : ventas.getProductos()) {%>
            <table>
                <thead>
                    <tr>
